...
case "$ARCH" in
  arm*)
    TAILSCALE_URL="https://raw.githubusercontent.com/m4dhouse/tailscale_bin/main/tailscale_1.84.2_arm_all.ipk"
    ;;
  mips*)
    TAILSCALE_URL="https://raw.githubusercontent.com/m4dhouse/tailscale_bin/main/tailscale_1.84.2_mipsel_all.ipk"
    ;;
  *)
