...
case "$ARCH" in
  arm*)
    TAILSCALE_URL="https://raw.githubusercontent.com/m4dhouse/tailscale_bin/main/tailscale_1.80.3_arm_all.ipk"
    ;;
  mips*)
    TAILSCALE_URL="https://raw.githubusercontent.com/m4dhouse/tailscale_bin/main/tailscale_1.80.3_mipsel_all.ipk"
    ;;
  *)
